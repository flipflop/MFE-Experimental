...
`);
  ...
  const appEntryRoute = await question("Please enter the entry route path of your application (using relative URL path). Note: this path will include your app_prefix: ");
